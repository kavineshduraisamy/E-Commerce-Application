...
import Jean from "./components/products/jeans";
import JeanDetail from "./components/products/productDetail/JeanPage";
import Sports from "./components/products/Sports";
import SportsDetail from "./components/products/productDetail/SportsPage";
import Kurta from "./components/products/Kurta";
import KurtaDetail from "./components/products/productDetail/KurtaPage";
...
function App() {
  ...
  return (
    <Router>
      ...
      <Route path="/sports/:code" component={SportsDetail} />
      <Route exact path="/mens" component={Product} />
      <Route path="/mens/:code" component={ProductDetail} />
      <Route exact path="/jeans" component={Jean} />
      <Route path="/jens/:code" component={JeanDetail} />
      <Route exact path="/kurtas" component={Kurta} />
      <Route path="/kurtas/:code" component={KurtaDetail} />
